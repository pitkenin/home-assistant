...
Walking into the bathroom gives you an adventurous transportation into the Jungle: vines cover the walls, birds sit on the shelves, and a monkey hangs from the ceiling holding a lightbulb that glows warm the moment you step in. A beat later the jungle wakes up around you, sound pouring out of ceiling speakers wired to a Raspberry Pi and orchestrated through Music Assistant. The soundtrack isn't static — it tracks the time of day, so late at night the room settles into crickets while the middle of the day brings birdsong back out. Stay long enough, and on the rare occasion you might catch a little melody slip in, a small easter egg that only shows up once in a while. Step up to the mirror to wash your hands and the cabinet light above it switches on by itself, sensing you're right there, then fades back out the moment you step away.
...
Motion handles most of the lighting around the house — the hallway lights itself as you pass through, and my bedroom light follows me the same way. But automatic lighting stops feeling clever the moment it does something you don't want, so both rooms sit next to a manual button as well. A single press takes the room off automatic and does exactly what you asked; a double press locks it fully on or fully off. The important part is what happens next: the override quietly expires on its own after a couple of hours, or resets the next morning, and the room slides back onto automatic without me ever having to remember to switch it back. The automation never fights you; it just steps aside when you want it to, and steps back in later, on its own schedule.

### Time of Day and Vibe Modes

Underneath all of it are two modes that almost everything else reads from. Time of Day moves through Morning, Day, Evening, and Night on its own schedule, deciding things like whether the hallway light comes on soft and dim or bright and full, or whether the Jungle is playing birds or crickets. Vibe Mode sits above it and is set by hand for a particular atmosphere, and it usually wins the argument when the two disagree. At night, lighting leans warmer and dimmer across the board. Switch on Maintenance and lights stay lit and sound stays off until I switch it back, useful for cleaning or fixing things without the house trying to help. Switch on Movie and the areas around the living room dim down so nothing spills onto the screen while someone's watching something good.
